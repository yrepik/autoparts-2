...
$('.addsuperh3').bind('click', function() {
	var superh3stat = $(this).hasClass('active');
	if (!superh3stat) {
		$(this).next(".addtypediv").slideDown('fast');
		$(this).addClass('active');
		superh3stat = true;
	} else {
		$(this).next(".addtypediv").slideUp('fast');
...
//--></script> 
<script type="text/javascript"><!--
	$('.advs .expand').on('click', function() {
		$(this).parent().find('.advh').slideToggle('fast');
	});
	$('.advs .advh .closeadvm').on('click', function() {
