<?php
// Text
$_['text_title']				= 'Klarna compte - salaire de %s/mois';
$_['text_terms']				= '<span id="klarna_account_toc"></span> <script type="text/javascript"> termes var = new Klarna.Terms.Account ({el: « klarna_account_toc », eid: «%s », pays: « %s »});</script>';
$_['text_information']			= 'Klarna infocomptes';
...
$_['error_address_match']		= 'Adresses d\'expédition et de facturation doivent correspondre si vous souhaitez utiliser les paiements Klarna';
