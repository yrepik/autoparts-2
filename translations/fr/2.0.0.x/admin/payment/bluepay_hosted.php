<?php
// Heading
$_['heading_title']            = 'BluePay hébergé forme';

// Text
$_['text_payment']             = 'Paiement';
$_['text_success']             = 'Succès : Vous avez modifié les détails de compte BluePay hébergé forme !';
$_['text_edit']                = 'Modifier BluePay hébergé forme';
$_['text_bluepay_hosted'] = '<a href="http://www.bluepay.com/preferred-partner/opencart" target="_blank"> <img src="view/image/payment/bluepay.jpg" alt="BluePay Redirect" title="BluePay Redirect" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_test']                = 'Test';
$_['text_live']                = 'direct';
$_['text_sale']                = 'Vente';
$_['text_authenticate']        = 'Authentifier';
$_['text_release_ok']          = 'Libération a réussi';
$_['text_release_ok_order']    = 'Libération a réussi';
...
$_['text_confirm_release']			= 'Êtes-vous certain de que vouloir libérer le paiement?';
$_['text_confirm_rebate']			= 'Êtes-vous certain de que vouloir rembourser le paiement?';

// Entry
$_['entry_account_name']			= 'Nom de compte';
...
$_['entry_card_discover']			= 'Découvrez';
$_['entry_total']					= 'Total';
...
$_['help_transaction']				= 'Méthode transactionnelle doit être défini sur paiement pour permettre les paiements d\'abonnement';
$_['help_cron_job_token']			= 'Rendre ce long et difficile à deviner';
$_['help_cron_job_url']				= 'Définissez une tâche cron pour appeler cette URL';

// Button
$_['btn_release']					= 'Liberer';
$_['btn_rebate']					= 'Remise / remboursement';
$_['btn_void']						= 'Vide';

// Error
$_['error_permission']				= 'AVERTISSEMENT : Vous n\'êtes pas autorisé à modifier le paiement BluePay!';
$_['error_account_name']			= 'Nom de compte requis!';
$_['error_account_id']				= 'ID de compte requis!';
$_['error_secret_key']				= 'Clé secrète requis!';