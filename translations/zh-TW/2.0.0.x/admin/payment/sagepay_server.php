...
// Text
$_['text_payment']					= '支付管理';
$_['text_success']					= '成功: 您已修改了SagePay 帳戶的詳細信息！';
$_['text_edit']                     = '編輯 SagePay Server';
...
$_['text_release_ok_order']			= '捕獲已成功，訂單狀態更新為成功 - 已解決';
...
$_['entry_card']					= '保存信用卡資料';
$_['entry_cron_job_token']			= '秘密標記';
$_['entry_cron_job_url']			= '例行性工作URL:';
$_['entry_last_cron_job_run']		= '最後一個例行性工作的運行時間:';
...
// Error
$_['error_permission']				= '警告: 您沒有權限修改 SagePay ！';
$_['error_vendor']					= '必須輸入供應商 ID ！';