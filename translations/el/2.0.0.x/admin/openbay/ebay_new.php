<?php
// Heading
$_['heading_title']               	= 'Νέα καταχώρηση';
$_['text_ebay']               		= 'eBay';
...
$_['text_return']                   = 'Επιστροφή στα προϊόντα';
...
$_['text_main_image_ebay']          = 'Κϋρια εικόνα στο eBay';
$_['text_image_ebay']               = 'Εικόνα στο eBay';
...
$_['text_created_title']            = 'Η καταχώρηση δημιουργήθηκε';
...
$_['text_ebay_images']              = 'Εικόνες στο eBay';
...
$_['column_stock_col_qty']          = 'Στη λίστα';
...
$_['column_stock_col_enabled']      = 'Ενεργοποιημένο';

// Entry
$_['entry_shop_category']           = 'Shop Category';
$_['entry_category_popular']        = 'Δημοφιλείς κατηγορίες';
$_['entry_category_suggested']      = 'eBay suggested category';
$_['entry_category']                = 'Category';
$_['entry_listing_condition']       = 'Item condition';
$_['entry_listing_duration']        = 'Διάρκεια καταχώρησης';
...
$_['tab_ebay_catalog']              = 'Κατάλογος eBay';
...
$_['error_listing_duration']      	= 'Επιλέξτε μία διάρκεια για την καταχώρηση, επιλέξτε κατηγορία για να φορτώσετε αυτίς τις επιλογές';
$_['error_image_size']          	= 'Ensure that you have a gallery and thumb image size';
$_['error_no_images']            	= 'Η καταχώρηση πρέπει να έχει τουλάχιστον μία εικόνα ανεβασμένη στο eBay';
