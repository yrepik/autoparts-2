...
$_['text_alert_ended']              = 'Η καταχώρηση σας στο eBay έχει τερματιστεί';

// Buttons
$_['button_view']					= 'Προβολή καταχώρησης';
$_['button_remove']					= 'Remove link';
$_['button_end']                    = 'Τερματισμός καταχώρησης';
...
$_['entry_stock_listed']			= 'Απόθεμα eBay';
