...
// Tabs
$_['tab_additional']      	= 'Πρόσθετες Πληροφορίες';

// Text
$_['text_option']      		= 'Επιλέξτε μία επιλογή';
$_['text_category_selected']= 'Category selected';
$_['text_material_add']  	= 'Προσθέστε υλικό';
$_['text_material_remove']  = 'Αφαίρεση υλικού';
$_['text_tag_add']  		= 'Προσθήκη ετικέτας';
$_['text_tag_remove']  		= 'Remove Tag';
$_['text_created']  		= 'Η καταχωρησή σας έχει δημιουργηθεί';
...
$_['entry_state']      		= 'Κατάσταση καταχώρησης';
...
$_['error_tags']  			= 'Μπορείτε να προσθέσετε μόνο 13 ετικέτες';