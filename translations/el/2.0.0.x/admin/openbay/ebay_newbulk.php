<?php
//Heading
$_['text_page_title']               = 'Μαζική καταχώρηση';
$_['text_ebay']               		= 'eBay';
$_['text_openbay']               	= 'OpenBay Pro';

// Buttons
$_['text_none']                     = 'Δεν έχει οριστεί';
$_['text_preview']                  = 'Προεπισκόπηση';
$_['text_add']                      = 'Προσθήκη';
$_['text_preview_all']              = 'Επιβεβαίωση όλων';
$_['text_submit']                   = 'Υποβολή';
$_['text_features']                 = 'Χαρακτηριστικά';
$_['text_catalog']                  = 'Επιλέξτε κατάλογο';
...
$_['text_suggested']         		= 'Προτεινόμενες κατηγορίες';
