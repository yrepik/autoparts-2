<?php
// Heading
$_['heading_title']        				= 'Συνδρομή';
$_['text_openbay']						= 'OpenBay Pro';
$_['text_amazon']						= 'Amazon ΗΠΑ';

// Text
$_['text_current_plan']             	= 'Current plan';
$_['text_register_invite']          	= "Δεν έχετε τα στοιχεία API σας ακόμα;";
...
$_['text_account_status']           	= 'Κατάσταση λογαριασμού';
...
$_['text_product_listings']         	= 'Καταχωρήσεις ανά μήνα';

// Columns
$_['column_name']                     	= 'Name';
$_['column_description']              	= 'Description';
$_['column_order_frequency']          	= 'Order import frequency';
$_['column_bulk_listing']             	= 'Μαζική καταχώρηση';
$_['column_product_listings']         	= 'Καταχωρήσεις ανά μήνα';
