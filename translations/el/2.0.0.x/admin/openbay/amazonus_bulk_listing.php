<?php
// Heading
$_['heading_title'] 				= 'Μαζική καταχώρηση';
...
$_['text_new'] 						= 'Νέο';
$_['text_used_like_new'] 			= 'Μεταχειρισμένο - Σαν καινούριο';
...
// Error
$_['error_product_sku'] 			= 'Το προϊόν πρέπει να έχει έναν κωδικό προϊόντος SKU';
