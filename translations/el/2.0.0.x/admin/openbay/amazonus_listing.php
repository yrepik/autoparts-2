<?php
// Heading
$_['heading_title'] 				= 'Νέα καταχώρηση στο Amazon';
$_['text_title_advanced'] 			= 'Advanced listing';
$_['text_openbay'] 					= 'OpenBay Pro';
$_['text_amazon'] 					= 'Amazon ΗΠΑ';

// Buttons
$_['button_new'] 					= 'Δημιουργία νέου προϊόντος';
...
$_['button_browse'] 				= 'Εξερεύνηση';
$_['button_saved_listings'] 		= 'Προβολή αποθηκευμένων καταχωρήσεων';
...
$_['text_uploaded'] 				= 'Οι αποθηκευμένες καταχωρήσεις μεταφορτώθηκαν!';
...
$_['text_edit_heading'] 			= 'Επεξεργασία καταχώρησης';
...
$_['column_sku'] 					= 'Κωδικός προΪόντος (SKU)';
$_['column_amazon_sku'] 			= 'Amazon item SKU';

// Entry
$_['entry_sku'] 					= 'Κωδικός προΪόντος (SKU)';
...
$_['error_connecting'] 				= 'Προειδοποίηση: Υπήρχε πρόβλημα σύνδεσης με το API. Παρακαλούμε ελέγξτε τις ρυθμίσεις σας στην επέκταση OpenBay Pro Amazon. Εάν το πρόβλημα παραμένει, επικοινωνήστε με την υποστήριξη.';
