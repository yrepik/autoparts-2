...
$_['text_payment_card']				= 'Δεκτές κάρτες';
$_['text_payment_desc']				= 'See description (e.g. bank transfer)';
$_['text_tax_use_listing'] 			= 'Χρησιμοποιήτε το σύνολο του φορολογικού συντελεστή στην καταχώρηση του eBay';
...
$_['text_listing_1day']             = '1 ημέρα';
$_['text_listing_3day']             = '3 ημέρες';
$_['text_listing_5day']             = '5 ημέρες';
$_['text_listing_7day']             = '7 ημέρες';
$_['text_listing_10day']            = '10 ημέρες';
$_['text_listing_30day']            = '30 ημέρες';
...
$_['help_listing_tax']     			= 'Αν χρησιμοποιείτε το συντελεστή από τις καταχωρήσεις σας, βεβαιωθήτε ότι τα προϊόντα σας έχουν το σωστό φόρο στο eBay';
