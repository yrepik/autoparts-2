<?php
// Heading
$_['heading_title']        = 'Συνδεθείτε με PayPal';

//Text
$_['text_module']          = 'Πρόσθετα';
$_['text_success']         = 'ΕΠΙΤΥΧΙΑ: Έχετε τροποποιήσει το Log In με την ενότητα PayPal !';
...
//Help
$_['help_sandbox']         = 'Θέλετε να χρησιμοποιήστε το περιβάλλον δοκιμών (sandbox);';
