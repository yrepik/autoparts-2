...
// Column
$_['tbl_column_date']				= 'Ημερομηνία';
$_['tbl_column_type']				= 'Τύπος';
$_['tbl_column_email']				= 'Ηλεκτρονικό ταχυδρομείο';
$_['tbl_column_name']				= 'Όνομα';
$_['tbl_column_transid']			= 'Κωδικός συναλλαγής';
$_['tbl_column_status']				= 'Κατάσταση';
$_['tbl_column_currency']			= 'Νόμισμα';
