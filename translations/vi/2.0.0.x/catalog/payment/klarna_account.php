<?php
// Text
$_['text_title']				= 'Tài khoản Klarna - trả tiền từ %s/month';
...
$_['text_information']			= 'Thông tin tài khoản Klarna';
...
$_['text_month']				= 'Tháng';
$_['text_day']					= 'Ngày';
$_['text_payment_option']		= 'Tùy chọn thanh toán';
$_['text_single_payment']		= 'Thanh toán đơn lẻ';
$_['text_monthly_payment']		= '%s - %s mỗi tháng';
...
$_['error_address_match']		= 'Địa chỉ thanh toán và vận chuyển phải phù hợp nếu bạn muốn sử dụng thanh toán Klarna';
