...
$_['heading_step_1_small']   = 'Пожалуйста, прочтите лицензионное соглашение OpenCart';
$_['heading_step_2']         = 'Предварительная установка';
$_['heading_step_2_small']   = 'Проверьте, правильно ли настроен Ваш сервер';
$_['heading_step_3']         = 'Конфигурация';
$_['heading_step_3_small']   = 'Введите параметры базы данных и администрирования';
$_['heading_step_4']         = 'Установка завершена';
$_['heading_step_4_small']   = 'Готово для начала продаж!';
$_['heading_maxmind']        = 'MaxMind';
$_['heading_maxmind_small']  = 'Служба обнаружения мошенничества.';
$_['heading_openbay']        = 'OpenBay Pro';
$_['heading_openbay_small']  = 'Интеграция нескольких торговых площадок';
...
$_['text_install_php']       = '1. Установите настройки PHP так, чтобы они соответствовали требованиям, указанным ниже.';
$_['text_install_extension'] = '2. Пожалуйста, убедитесь, что установлены расширения PHP, перечисленные ниже.';
$_['text_install_db']        = '3. Убедитесь, что у Вас доступен по крайней мере один драйвер базы данных.';
$_['text_install_file']      = '4. Пожалуйста, убедитесь в том, что Вы установили правильные разрешения на файлы из приведенного ниже списка.';
$_['text_install_directory'] = '5. Пожалуйста, убедитесь в том, что Вы установили правильные разрешения на папки из приведенного ниже списка.';
$_['text_db_connection']     = '1. Пожалуйста, введите параметры для подключения к базе данных.';
$_['text_db_administration'] = '2. Введите логин и пароль администратора.';
...
$_['text_global']            = 'PHP register_globals';
$_['text_magic']             = 'PHP magic_quotes_gpc';
$_['text_file_upload']       = 'Загрузка файла';
$_['text_session']           = 'PHP session.auto_start';
...
$_['text_missing']           = 'Утеряно';
$_['text_forget']            = 'Не забудьте удалить папку install!';
$_['text_shop']              = 'Перейти на сайт магазина';
$_['text_login']             = 'Войти в админ-панель';
$_['text_project']           = 'Сайт проекта';
$_['text_documentation']     = 'Документация';
$_['text_support']           = 'Форум поддержки';
$_['text_footer']            = 'Copyright © 2014 OpenCart - все права защищены';
$_['text_loading']           = 'Загрузка модулей...';
$_['text_store']             = 'перейти к магазину расширений';
$_['text_mail_list']         = 'Подписка на рассылку';
$_['text_mail_list_small']   = 'Будьте в курсе обновлений и событий OpenCart.';
$_['text_openbay']   		 = 'OpenBay Pro дает возможность связывать магазин с такими площадками, как eBay и Amazon, импортировать заказы, элементы списка и информацию о доставке непосредственно из OpenCart...';
$_['text_maxmind']   		 = 'MaxMind обеспечивает возможность быстрого выявления рискованных сделок, снижает риск мошенничества и минимизирует время обработки заказов, давая оценку риска для каждого из них...';
$_['text_more_info']   		 = 'Дополнительная информация';
$_['text_facebook']   		 = 'Лайкни нас на Facebook';
$_['text_facebook_info']     = 'Расскажите, насколько Вам понравился OpenCart!';
$_['text_facebook_link']     = 'Посетите нашу страницу в Facebook';
$_['text_forum']    	 	 = 'Форумы сообщества';
$_['text_forum_info']    	 = 'Получите помощь от других пользователей OpenCart';
$_['text_forum_link']    	 = 'Посетите наши форумы';
$_['text_commercial']    	 = 'Коммерческая поддержка';
$_['text_commercial_info']   = 'Услуги для Вашего бизнеса от партнеров OpenCart';
$_['text_commercial_link']   = 'Посетите страницу наших партнеров';
$_['text_view']   		     = 'Подробнее';
$_['text_download']   		 = 'Cкачать';
$_['text_downloads']   		 = 'Загрузки';
$_['text_price']   		 	 = 'Цена';
$_['text_view']   		     = 'Подробнее';
$_['text_maxmind_success']   = 'Служба борьбы с мошенничеством MaxMind  установлена.';
$_['text_maxmind_top']   	 = 'Если у вас нет лицензионного ключа вы можете';
$_['text_maxmind_link']   	 = 'подписаться здесь';
$_['text_ebay_about']	 	 = 'eBay - это многомиллиардная торговая площадка, которая позволяет компаниям или частным продавцам торговать на аукционе и продавать свои товары онлайн. Доступна для продавцов во всем мире.';
$_['text_amazon_about']	 	 = 'Amazon - это торговая онлайн-площадка с фиксированными ценами, позволяющая продавцам предлагать новые и подержанные товары наряду с обычными продуктами сервиса Amazon.';

// Entry
$_['entry_db_driver']        = 'Драйвер DB';
...
$_['entry_risk']      		 = 'Оценка риска';
$_['entry_fraud_status']     = 'Статус заказа мошенника';

// Help
$_['help_maxmind_risk']      = 'Выберите значение от 0 до 100. Высокий балл - высокий показатель мошенничества.';
$_['help_maxmind_fraud']     = 'Заказы, которым будет присвоен данный статус, не будут обработаны автоматически.';

// Error
$_['error_key'] 			 = 'Требуется лицензионный ключ MaxMind';
$_['error_score'] 			 = 'Введите значение от 0 до 100';
$_['error_db_hostname'] 	 = 'Укажите имя хоста!';
$_['error_db_username'] 	 = 'Требуется имя пользователя!';
$_['error_db_database']		 = 'Укажите имя базы данных!';
$_['error_db_prefix'] 		 = 'Префикс DB может содержать только буквы нижнего регистра: a-z, цифры: 0-9 и знак подчеркивания';
$_['error_db_connect'] 		 = 'Ошибка: Не удалось подключиться к базе данных. Пожалуйста, убедитесь, что сервер базы данных, имя пользователя и пароль указаны верно!';
$_['error_username'] 		 = 'Требуется имя пользователя!';
$_['error_password'] 		 = 'Требуется пароль!';
$_['error_email'] 			 = 'Неверный E-Mail!';
$_['error_config'] 			 = 'Ошибка: Не удалось записать config.php. Пожалуйста, проверьте права доступа на файл: ';

// Buttons
$_['button_continue']        = 'Продолжить';
$_['button_back']            = 'Назад';
$_['button_join']            = 'Присоединяйтесь!';
$_['button_setup']           = 'Установить сейчас';
$_['button_register']        = 'Регистрация';
$_['button_register_eu']     = 'Регистрация для Европы';
$_['button_register_us']     = 'Регистрация для США';

$_['text_terms'] = 'Неофициальный Перевод GNU GPLv3
...
Если Вы разрабатываете новую программу и хотите чтобы она была максимально полезна общественности, лучший способ добиться желаемого - сделать программу свободным ПО, которое к';
