...
<div style="margin-bottom:20px;">
  ...
  <div class="text-left">
   ...
   <div class="col-sm-2 text-left" style='margin-top:2%'>
  	<input type="button" onclick="validation();" class="btn btn-primary" id="button-search" value="Search">&nbsp;&nbsp;<img id="ajaxloader" style="display:none;" src="image/loder.gif" />
  </div>
